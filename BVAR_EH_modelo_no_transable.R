...
endogenas <- data_final[, c(
  "d1_itcer", "d1_iti", "d1_no_transable",
  "d1_transable", "d1_ipi_eeuu", "d1_remesas"   
)]
...
#lista combinada
todos_los_irfs_no_transable <- do.call(rbind, irf_combinados_no_transable)

#excel
hoja_irf <- list(
  "Irfs_Total" = todos_los_irfs_no_transable,           #todos los irfs
  "Remesas_ITCER" = todos_los_irfs_no_transable[1],  #separados
  "ITCER_Transable" = todos_los_irfs_no_transable[5]
)

#exportarlo
write.xlsx(hoja_irf, file = "irf_total(modelo_no_transable).xlsx")
...
#lista usada 
irf_list_acum_no_transable <- list(
  get_irf_acumulada(irf_all, "d1_remesas", "d1_itcer"),
  get_irf_acumulada(irf_all, "d1_ipi_eeuu", "d1_itcer"),
  get_irf_acumulada(irf_all, "d1_itcer", "d1_no_transable"),
  get_irf_acumulada(irf_all, "d1_iti", "d1_itcer")
...
#lista combinada
todos_los_irfs_acum_no_transable <- do.call(rbind, irf_list_acum_no_transable)

#excel
hoja_irf_acum_no_transable <- list(
  "Irfs_Total_acum_transable" = todos_los_irfs_acum_no_transable  #todos los irfs
)

#exportarlo
write.xlsx(hoja_irf_acum_no_transable, file = "irf_total_acum_no_transable.xlsx")
...
#exportar a excel
shocks <- c("d1_remesas", "d1_itcer", "d1_no_transable")
sheets <- list()
...
#el excel
out <- "fevd_modelo_no_transable.xlsx"
